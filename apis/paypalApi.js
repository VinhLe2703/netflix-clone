...
let clientId = 'AWmP0IjzA6B0n1Phl5PJIdcs3HpCG_i8zCAle1rWn2z3cWZogkbvdPQ08UPAOBWhHTEE81uRCvcV4DT8';
let secretKey = 'EB8fSSzGKFu5L61nY6Tf3tZO206G07kqDwez0XucoOHtckgvQljJv9iD2VXTU7zP98Zzuxc0hyHx8KGQ';


const createOrderDetail = (amount) => {
    return {
        "intent": "CAPTURE",
        "purchase_units": [
            {
...
const createOrder = (token = '', amount) => {
    const orderDetail = createOrderDetail(amount);
    var requestOptions = {
        method: 'POST',
        headers: {
